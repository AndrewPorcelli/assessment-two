...
function canWeDeliver(zipcode) {
  if (deliveryAreaZipCodes.includes(zipcode)) {
    return `The zipcode ${zipcode} is eligible for delivery`;
  } else {
    return `The zipcode ${zipcode} is not eligible for delivery 😢`;
  }
}

console.log(canWeDeliver(85205));
console.log(canWeDeliver(91000));
// console.log(canWeDeliver(85203));
// console.log(canWeDeliver(85555));
...
const tenOff = deals[0].title.replace('15', '10');
console.log(tenOff);
...
const aprilDesc = deals[1].desc.replace('March', 'April').trim()
console.log(aprilDesc);
